...
class PageOne(tk.Frame):
    def __init__(self, parent, contoller):
        ...
        button2 = ttk.Button(self, text='Visit Page 2', command=lambda: contoller.show_frame(PageTwo))
        button2.pack()
...
class PageTwo(tk.Frame):
    def __init__(self, parent, contoller):
        ...
        button2 = ttk.Button(self, text='Visit Page 1', command=lambda: contoller.show_frame(PageOne))
        button2.pack()
...
class PageThree(tk.Frame):
    def __init__(self, parent, contoller):
        ...
        a = f.add_subplot(111)
        a.plot([1,2,3,4,5,6,7,8], [4,8,2,4,7,5,2,8])
